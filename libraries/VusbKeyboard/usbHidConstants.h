/* This is derived from http://svn.modlabupenn.org/mod-ros-pkg/wixel/sdk/libraries/include/usb_hid_constants.h */
...
#define LED_KANA            (1<<4)
#define LED_POWER           (1<<5)
#define LED_SHIFT           (1<<6)
#define LED_DO_NOT_DISTURB  (1<<7)
